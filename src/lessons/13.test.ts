import {getBanknoteList, getSum, getTriangleType, isEvenIndexSumGreater, getSquarePositiveIntegers, sum, sumFirstNumbers} from "./13";
...
test("sum of first N numbers", () => {
    ...
    expect(sumFirstNumbers(15)).toBe(55)
})
